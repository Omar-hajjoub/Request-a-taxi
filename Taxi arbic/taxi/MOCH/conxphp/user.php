       ...
       <div class="user-dropdown" id="user-dropdown">
          <div class="usrelog">
            <div class="cart_item">
              <img src="img.png" alt="" id="img1" />
               <input type="file" id="fil" />
              <button id="sign-out" ><a href="../index.php"> Sign Out </a></button>
            </div>
...
<div  class="container-1 " >
 ...
 <div class="contr1">
  ...
  <h1>TO WALCOME <span>TAXIOW</span> </h1>

  <p>We offer you a taxi delivery service at the door of your home or place, whatever it is</p>
...
<div class="im">
  ...
  <img  src="photo/manhattan-street-lady-1026248.jpg" alt="">
  </div>
...
<div class="login  ">
  ...
  <div class="login-left">
    <div class="hidden">
 <h1>Become a partner and earn money!</h1>
 <ul>
  <li><i class="fa-sharp fa-solid fa-star" style="color: #f0dd0f;"></i>Free work schedule
  </li>
  <li><i class="fa-sharp fa-solid fa-star" style="color: #f0dd0f;"></i> Absence of mandatory orders
  </li>
  <li><i class="fa-sharp fa-solid fa-star" style="color: #f0dd0f;"></i> Lack of introductory payments
  </li>
  <li><i class="fa-sharp fa-solid fa-star" style="color: #f0dd0f;"></i>We accept all types of vehicles
  </li>
 </ul>
 <div class="bs">
  ...
  <div class="login-right">
    <div class="hidden">
 <h1>Order a Taxi</h1>
<h2>online or on the app</h2>

<ul>
  <li><i class="fa-solid fa-bolt" style="color: #f5ed0a;"></i>  Ordering a taxi online or on the app.</li>
  <li><i class="fa-solid fa-bolt" style="color: #f5ed0a;"></i>Tracking car approximation online.
  </li>
  <li><i class="fa-solid fa-bolt" style="color: #f5ed0a;"></i> Payment in cash, card or bonuses.
  </li>
  <li><i class="fa-solid fa-bolt" style="color: #f5ed0a;"></i>Estimated cost of the trip in advance.
  </li>
  <li><i class="fa-solid fa-bolt" style="color: #f5ed0a;"></i>Rating system for drivers and passengers.
  </li>
  <li><i class="fa-solid fa-bolt" style="color: #f5ed0a;"></i> Saving the previous trips history.
  </li>
</ul>
   <div class="bs1">
    <button onclick="redirectToPage2()">
...
<div class="ro">
  ...
  <div class="asi">
    <aside>
  <button id="bt1" onclick="div1()"  >
    <i class="fa-solid fa-taxi fa-beat-fade" ></i> my taxi
  </button>
  <button id="bt2" onclick="div2()"  ><i class="fa-solid fa-code-pull-request fa-beat-fade" style="color: #060303;"></i> to request</button>
  <button id="bt3" onclick="div3()"  ><i class="fa-solid fa-truck-fast fa-beat-fade" style="color: #0c0c0f;"></i> Emergency services</button>
</aside>
</div>
...
<div class="card_content">
    <span class="card_title">Taking A Petit Taxi</span>
...
<div class="card_content">
  <span class="card_title">Taking A Grand Taxi</span>
      <span class="card_subtitle">Thsi is a subtitle of this page. Let us see how it looks on the Web.</span>
      <p class="card_description">Lorem ipsum dolor, sit amet  expedita exercitationem recusandae aut dolor tempora aperiam itaque possimus at, cupiditate earum, quae repudiandae aspernatur? Labore minus soluta consequatur placeat.</p>
      <button>
        <span>Continue</span>
  ...
  <div class="card_content">
    <span class="card_title">Private Taxis</span>
        <span class="card_subtitle">Thsi is a subtitle of this page. Let us see how it looks on the Web.</span>
        <p class="card_description">Lorem ipsum dolor, sit amet  expedita exercitationem recusandae aut dolor tempora aperiam itaque possimus at, cupiditate earum, quae repudiandae aspernatur? Labore minus soluta consequatur placeat.</p>
        <button>
          <span>Continue</span>
...
<div class="to-request" id="div2">
 <div class="carts">
  ...
  <div class="for">
    <div class="cart_item">
      <img src="/taxi/img.png" alt="" id="img1"/>
      <input type="file" id="fil" />
    </div>
    <div class="no">
...
<div class="ba2">
  <div class="hidden">
    <div class="ul1">
    <ul>
      <li><a href="#"><i class="fa-solid fa-address-card" style="color: #faf9f5;"></i> About us</a></li>
      <li><a href="#"><i class="fa-solid fa-circle-info" style="color: #f5f7f9;"></i> Help Center</a></li>
      <li><a href="#"><i class="fa-solid fa-key" style="color: #f6f7f9;"></i> Contacts</a></li>
    </ul>
  </div>
  </div>
  <div class="hidden">
  ...
  <div class="ba3">
     ...
     <p>TAXIOW Corporation . <span>All rights reserved © 2022</span> </p>
