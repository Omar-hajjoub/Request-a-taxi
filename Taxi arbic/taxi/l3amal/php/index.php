...
<?php if($reslt>0){?>
 ...
 <?php }else{
  ...
  echo "<td>". $nortlab."</td>","<td>". $nortlab."</td>","<td>". $nortlab."</td>","<td>". $nortlab."</td>","<td>". $nortlab."</td>";;
    ...
    var butnrefuse =document.getElementById('refuse');
   
   function butnrefuse(row){
console.log(row)
   }
